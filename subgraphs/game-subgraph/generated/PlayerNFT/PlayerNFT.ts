...
export class PlayerNFT__getWorldStatsResultValue0Struct extends ethereum.Tuple {
  get joinedAt(): BigInt {
...
export class PlayerNFT extends ethereum.SmartContract {
  ...
  getWorldStats(
    user: Address,
    worldId: BigInt,
  ): PlayerNFT__getWorldStatsResultValue0Struct {
    let result = super.call(
      "getWorldStats",
      "getWorldStats(address,uint256):((uint256,uint256,uint256))",
      [
        ethereum.Value.fromAddress(user),
    ...
    return changetype<PlayerNFT__getWorldStatsResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getWorldStats(
    user: Address,
    worldId: BigInt,
  ): ethereum.CallResult<PlayerNFT__getWorldStatsResultValue0Struct> {
    let result = super.tryCall(
      "getWorldStats",
      "getWorldStats(address,uint256):((uint256,uint256,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<PlayerNFT__getWorldStatsResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
...
export class UpdateWorldStatsCall extends ethereum.Call {
  get inputs(): UpdateWorldStatsCall__Inputs {
    return new UpdateWorldStatsCall__Inputs(this);
  }

  get outputs(): UpdateWorldStatsCall__Outputs {
    return new UpdateWorldStatsCall__Outputs(this);
  }
}

export class UpdateWorldStatsCall__Inputs {
  _call: UpdateWorldStatsCall;

  constructor(call: UpdateWorldStatsCall) {
    this._call = call;
  }
...
export class UpdateWorldStatsCall__Outputs {
  _call: UpdateWorldStatsCall;
